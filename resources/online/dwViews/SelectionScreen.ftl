    ...
    <body onload="initalize()"> <!-- Call the initalize method when the page loads -->
		...
		<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
			...
			<div class="collapse navbar-collapse" id="navbarMenu"><ul class="navbar-nav">
					...
					<li class="nav-item"><a href="http://localhost:7777/toptrumps/stats/" class="nav-link">Statistics</a>
					</li>
				</ul>
			</div>
		</nav>
			...
			<div class="row justify-content-around my-row">
				<div class="col my-col">						
					<div class="alert alert-primary" role="alert">
						<a href="http://localhost:7777/toptrumps/game/" class="alert-link">New Game</a>
					</div>
				...
				<div class="col my-col">						
					<div class="alert alert-primary" role="alert">
						<a href="http://localhost:7777/toptrumps/stats/" class="alert-link">Game Statistics</a>
					</div>
					<div class="alert alert-light" role="alert">
